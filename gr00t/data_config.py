...
class FrankaTripleCamDataConfig(BaseDataConfig):
    video_keys = [
        "video.left_view",
        "video.right_view",
        "video.wrist_view",
    ]
    state_keys = [ # Remove 'state.arm' when Learning is done
        "state.eef_position",
    ...
    state_target_rotations = {
        "state.eef_quaternion": "rotation_6d",
    }
    action_normalization_modes = {
...
DATA_CONFIG_MAP = {
    ...
    "franka_triple_cam": FrankaTripleCamDataConfig(),
}
