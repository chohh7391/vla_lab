...
import vla_lab.tasks.manager_based.base_line.stack.mdp.gr00t_observations as gr00t_obs
...
@configclass
class FrankaCubeStackGr00tEnvCfg(stack_joint_pos_env_cfg.FrankaCubeStackEnvCfg):
    ...
    def __post_init__(self):
        ...
        # Set cameras
        self.scene.left_camera = CameraCfg(
            prim_path="{ENV_REGEX_NS}/left_camera",
            update_period=0.0,
            width=256,
            height=256,
        ...
        self.scene.right_camera = CameraCfg(
