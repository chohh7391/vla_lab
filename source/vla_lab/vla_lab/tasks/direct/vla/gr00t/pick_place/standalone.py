    ...
    while simulation_app.is_running():
        ...
        if SimulationManager.is_simulating():
            ...
            if reset_needed:
                ...
                gripper_qpos_prev = pick_place.robot.get_dof_positions(dof_indices=[7])[0]
            ...
            gripper_qpos = pick_place.robot.get_dof_positions(dof_indices=[7])[0]
            ...
            if env_id < num_envs:
                ...
                buf["index"].append(episode_step) # episode_step 사용
